...
if [ "$(uname -m)" = "armv7l" ]; then
  ...
  echo "https://github.com/Chia-Network/maize-blockchain/wiki/Raspberry-Pi"
  echo "Exiting."
  exit 1
fi
# Get submodules
...
python -m pip install --extra-index-url https://pypi.maize.net/simple/ miniupnpc==2.2.2
python -m pip install -e ."${EXTRAS}" --extra-index-url https://pypi.maize.net/simple/

echo ""
echo "Maize blockchain install.sh complete."
echo "For assistance join us on Keybase in the #support chat channel:"
echo "https://keybase.io/team/maize_network.public"
echo ""
echo "Try the Quick Start Guide to running maize-blockchain:"
echo "https://github.com/Chia-Network/maize-blockchain/wiki/Quick-Start-Guide"
echo ""
