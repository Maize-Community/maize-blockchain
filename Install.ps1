...
venv\scripts\pip install --extra-index-url https://pypi.maize.net/simple/ miniupnpc==2.2.2
venv\scripts\pip install --editable ".$extras_cli" --extra-index-url https://pypi.maize.net/simple/
...
Write-Output "https://keybase.io/team/maize_network.public"
Write-Output ""
Write-Output "Try the Quick Start Guide to running maize-blockchain:"
Write-Output "https://github.com/Chia-Network/maize-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
